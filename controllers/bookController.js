...
exports.book_create_post = [
  ...
  asyncHandler(async (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      // Data from form is valid. Save to database.
      await book.save();
...
exports.book_delete_get = asyncHandler(async (req, res, next) => {
  // Get details of book and all it's instances (in parallel)
...
exports.book_delete_post = asyncHandler(async (req, res, next) => {
  ...
  if (allBookInstances.length > 0) {
    ...
    // Book has no instances. Delete the book and return to all books list
...
exports.book_update_post = [
  ...
  asyncHandler(async (req, res, next) => {
    ...
    const book = new Book({
      ...
      _id: req.params.id, // Required so a new ID isn't automatically assigned!!
    });
